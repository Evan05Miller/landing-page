...
export default function HeroSection({ children }: Props) {
      ...
      const drawLine = (a: Dot, b: Dot) => {
        ...
        if (active) {
          ...
          if (md < INFLUENCE_RADIUS * 1.3) {
            alpha += (1 - md / (INFLUENCE_RADIUS * 1.3)) * 0.28;
          }
        }
  ...
  return (
    <section
      ref={sectionRef}
      className="hero-mesh text-white py-24 md:py-32 relative overflow-hidden"
    >
      <canvas
        ref={canvasRef}
        ...
        aria-hidden="true"
      />
      <div className="absolute inset-0 z-[1] bg-gradient-to-b from-transparent via-emerald-950/10 to-emerald-950/25 pointer-events-none" />
